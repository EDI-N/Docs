...
.. csv-table:: Отчет об отгрузке (CONTRL) является завершающим документом в логике документооборота с ТС Фоззи - отправляется Поставщиком в ответ на RECADV (Уведомление о приеме)
