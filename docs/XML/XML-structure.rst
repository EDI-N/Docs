...
Акт несоответствия (COMDOC_009)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. csv-table:: Акт несоответствия (COMDOC_009)
...
.. csv-table:: Статус (STATUS) служит для оповещения пользователя, что документ, который он отправил, был доставлен на платформу EDI-N и прочитан адресатом.
...
Отчет об отгрузке (CONTRL)
=============================================

.. csv-table:: Отчет об отгрузке (CONTRL) является завершающим документом в логике документооборота с ТМ Фоззи - отправляется Поставщиком в ответ на RECADV (Уведомление о приеме)
