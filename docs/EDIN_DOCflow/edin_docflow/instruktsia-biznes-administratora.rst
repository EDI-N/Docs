...
15 Аналітика
------------
Розділ у якому можливо створити звіт про документообіг, відображається тільки користувачам з ввімкненими ролями на даний розділ (меню "Керування доступом" → "Ролі" → "Розділи"). 
