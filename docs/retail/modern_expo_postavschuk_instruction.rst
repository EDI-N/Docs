...
1. **Будет доставлено** — данная товарная позиция будет доставлена в полном объеме 
2. **Изменение к-ства** — данная товарная позиция будет доставлена не в полном объеме
3. **Отказано** — данная товарная позиция доставлена не будет 
...
6 Уведомление об отгрузке (Desadv)
====================================
