...
+=====+===================+=======+========+=====================================================+
| 1   | glnID             | O     | int    | идентификатор GLN пользователя в системе            |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 2   | productID         | O     | long   | идентификатор товара                                |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 3   | name              | O     | String | наименование позиции                                |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 4   | gtin              | **M** | String | штрих-код                                           |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 5   | ownNum            | O     | String | внутренний номер продукта                           |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 6   | value             | O     | String | количество                                          |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 7   | price             | O     | String | цена с НДС                                          |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 8   | basePrice         | O     | float  | цена без НДС                                        |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 9   | pkg               | O     | double | упаковка                                            |
+-----+-------------------+-------+--------+-----------------------------------------------------+
...
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 14  | customTariff      | O     | String | номер ГТД                                           |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 15  | countryCode       | O     | String | код страны производителя (согласно ISO 3166-1)      |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 16  | prodKpp           | O     | String | КПП производителя/импортёра                         |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 17  | prodInn           | O     | String | ИНН производителя/импортёра                         |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 18  | partNumber        | O     | String | номер партии                                        |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 19  | certificat        | O     | String | сертификат                                          |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 20  | foreignTrade      | O     | String | код УКТ ВЭД                                         |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 21  | customTariffDate  | O     | String |                                                     |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 22  | alcoCode          | O     | int    | код алкогольной продукции                           |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 23  | partyName         | O     | String | название производителя/импортёра                    |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 24  | importPartyName   | O     | String | название производителя импорта (только для импорта) |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 25  | displacement      | O     | String | литраж единицы продукции                            |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 26  | boxweight         | O     | String | вес коробки                                         |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 27  | alcoLic           | O     | String | серия, номер лицензии на алкоголь                   |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 28  | licGiven          | O     | String | кем выдана лицензия                                 |
+-----+-------------------+-------+--------+-----------------------------------------------------+
...
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 34  | certGiven         | O     | String | кем выдан сертификат                                |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 35  | egaisCode         | O     | String | код ЕГАИС                                           |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 36  | egaisLineNum      | O     | String | номер строки ЕГАИС                                  |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 37  | numbOfBuyer       | O     | String | артикул покупателя                                  |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 38  | lotNumber         | O     | String | номер лота товара                                   |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 39  | shelfLife         | O     | long   | срок годности                                       |
+-----+-------------------+-------+--------+-----------------------------------------------------+
| 40  | isImportedProduct | O     | int    | признак импортированного товара                     |
+-----+-------------------+-------+--------+-----------------------------------------------------+
